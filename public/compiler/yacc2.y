...
ExpressionOptional: /* TODO: check this */
    Expression
    |
    ;
...
Block:
    ...
    //| LEFT_BRACE RIGHT_BRACE /* TODO: not included, check this */
    ;
...
StatementListOptional: /* TODO: not included, check this */
    StatementList
    |
    ;
...
FunctionExpression: /* TODO: BindingIdentifier is optional so this line could be duplicated without it */
    FUNCTION BindingIdentifier LEFT_PAREN FormalParameters RIGHT_PAREN LEFT_BRACE FunctionBody RIGHT_BRACE
    ;
...
GeneratorExpression :
    // TODO: BindingIdentifier is optional so maybe it could be duplicated without it
...
ClassExpression:
    // TODO: BindingIdentifier is optional
    CLASS BindingIdentifier ClassTail { printf("- ClassExpression at line %d\n", line); }
    ;

ClassTail:
    // TODO: ClassHeritage and ClassBody are optional
